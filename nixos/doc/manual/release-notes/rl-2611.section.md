...
- [btop](https://github.com/aristocratos/btop), a resource monitor, is available with the capabilities required for process and GPU monitoring through [programs.btop](#opt-programs.btop.enable).
